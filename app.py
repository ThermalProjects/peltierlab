...
dynamic_static = st.sidebar.radio("Simulation mode", ["Dynamic", "Static"], index=0, horizontal=True)
...
if st.session_state['running_state']:
    ...
    for i in range(len(t_full)):
        ...
        # Overshoot: corregido (solo después de 2 cruces)
